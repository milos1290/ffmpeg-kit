...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler, PluginRegistry.ActivityResultListener {
    ...
    public boolean onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        if (requestCode == READABLE_REQUEST_CODE || requestCode == WRITABLE_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                if (data == null) {
                    resultHandler.success(lastInitiatedIntentResult, null);
                } else {
                    final Uri uri = data.getData();
                    resultHandler.success(lastInitiatedIntentResult, uri == null ? null : uri.toString());
                }
            } else {
                resultHandler.error(lastInitiatedIntentResult, "SELECT_CANCELLED", String.valueOf(resultCode));
            }
        ...
        switch (call.method) {
            case "abstractSessionGetEndTime":
                if (sessionIdOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_SESSION", "Invalid session id.");
                }
                break;
            ...
            case "ffmpegSession":
                if (argumentsOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_ARGUMENTS", "Invalid arguments array.");
                }
                break;
            ...
            case "mediaInformationJsonParserFrom":
                if (ffprobeJsonOutputOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_FFPROBE_JSON_OUTPUT", "Invalid ffprobe json output.");
                }
                break;
            ...
            case "setFontconfigConfigurationPath":
                ...
                if (pathOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_PATH", "Invalid path.");
                }
                break;
            case "setFontDirectory": {
                ...
                if (fontDirectoryOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_FONT_DIRECTORY", "Invalid font directory.");
                }
                break;
            }
            case "setFontDirectoryList": {
                ...
                if (fontDirectoryListOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_FONT_DIRECTORY_LIST", "Invalid font directory list.");
                }
                break;
            }
            ...
            case "closeFFmpegPipe":
                ...
                if (ffmpegPipePathOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_PIPE_PATH", "Invalid ffmpeg pipe path.");
                }
                break;
            ...
            case "setEnvironmentVariable":
                ...
                if (variableNameOptional.isPresent() && variableValueOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_NAME", "Invalid environment variable name.");
                } else {
                    resultHandler.error(result, "INVALID_VALUE", "Invalid environment variable value.");
                }
                break;
            case "ignoreSignal":
                ...
                if (signalOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_SIGNAL", "Invalid signal value.");
                }
                break;
            ...
            case "setLogLevel":
                ...
                if (levelOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_LEVEL", "Invalid level value.");
                }
                break;
            ...
            case "setSessionHistorySize":
                ...
                if (sessionHistorySizeOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_SIZE", "Invalid session history size value.");
                }
                break;
            case "getSession":
                if (sessionIdOptional.isPresent()) {
            ...
            case "getSessionsByState":
                ...
                if (stateOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_SESSION_STATE", "Invalid session state value.");
                }
                break;
            ...
            case "setLogRedirectionStrategy":
                ...
                if (strategyOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_LOG_REDIRECTION_STRATEGY", "Invalid log redirection strategy value.");
                }
                break;
            ...
            case "writeToPipe":
                ...
                if (inputOptional.isPresent() && pipeOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_INPUT", "Invalid input value.");
                } else {
                    resultHandler.error(result, "INVALID_PIPE", "Invalid pipe value.");
                }
                break;
            case "selectDocument":
                ...
                if (writableOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_WRITABLE", "Invalid writable value.");
                }
                break;
            case "getSafParameter":
                ...
                if (writableOptional.isPresent() && uriOptional.isPresent()) {
                    ...
                    resultHandler.error(result, "INVALID_URI", "Invalid uri value.");
                }
                break;
            case "cancel":
                if (sessionIdOptional.isPresent()) {
                    cancel(sessionIdOptional.get(), result);
                } else {
                    cancel(result);
                }
                break;
    ...
    protected void abstractSessionGetEndTime(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            resultHandler.error(result, "SESSION_NOT_FOUND", "Session not found.");
        } else {
            final Date endTime = session.getEndTime();
            if (endTime == null) {
                resultHandler.success(result, null);
            } else {
                resultHandler.success(result, endTime.getTime());
            }
        }
    }
    ...
    protected void abstractSessionGetDuration(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            resultHandler.success(result, session.getDuration());
        }
    }
    ...
    protected void abstractSessionGetAllLogs(@NonNull final Integer sessionId, @Nullable final Integer waitTimeout, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            resultHandler.success(result, allLogs.stream().map(FFmpegKitFlutterPlugin::toMap).collect(Collectors.toList()));
        }
    }
    ...
    protected void abstractSessionGetAllLogsAsString(@NonNull final Integer sessionId, @Nullable final Integer waitTimeout, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            resultHandler.success(result, allLogsAsString);
        }
    }
    ...
    protected void abstractSessionGetState(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            resultHandler.success(result, session.getState().ordinal());
        }
    }
    ...
    protected void abstractSessionGetReturnCode(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            if (returnCode == null) {
                ...
                resultHandler.success(result, returnCode.getValue());
            }
        }
    }
    ...
    protected void abstractSessionGetFailStackTrace(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            resultHandler.success(result, session.getFailStackTrace());
        }
    }
    ...
    protected void abstractSessionThereAreAsynchronousMessagesInTransmit(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            resultHandler.success(result, session.thereAreAsynchronousMessagesInTransmit());
        }
    }
    ...
    protected void getArch(@NonNull final Result result) {
        resultHandler.success(result, AbiDetect.getAbi());
    }
    ...
    protected void ffmpegSession(@NonNull final List<String> arguments, @NonNull final Result result) {
        ...
        resultHandler.success(result, toMap(session));
    }
    ...
    protected void ffmpegSessionGetAllStatistics(@NonNull final Integer sessionId, @Nullable final Integer waitTimeout, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            if (session instanceof FFmpegSession) {
                ...
                resultHandler.success(result, allStatistics.stream().map(FFmpegKitFlutterPlugin::toMap).collect(Collectors.toList()));
            } else {
                resultHandler.error(result, "NOT_FFMPEG_SESSION", "A session is found but it does not have the correct type.");
            }
        }
    }
    ...
    protected void ffmpegSessionGetStatistics(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            if (session instanceof FFmpegSession) {
                ...
                resultHandler.success(result, statistics.stream().map(FFmpegKitFlutterPlugin::toMap).collect(Collectors.toList()));
            } else {
                resultHandler.error(result, "NOT_FFMPEG_SESSION", "A session is found but it does not have the correct type.");
            }
        }
    ...
    protected void mediaInformationJsonParserFrom(@NonNull final String ffprobeJsonOutput, @NonNull final Result result) {
        try {
            ...
            resultHandler.success(result, toMap(mediaInformation));
    ...
    protected void mediaInformationJsonParserFromWithError(@NonNull final String ffprobeJsonOutput, @NonNull final Result result) {
        try {
            ...
            Log.i(LIBRARY_NAME, "Parsing MediaInformation failed.", e);
            resultHandler.error(result, "PARSE_FAILED", "Parsing MediaInformation failed with JSON error.");
        }
    }
    ...
    protected void setFontDirectory(@NonNull final String fontDirectoryPath, @Nullable final Map<String, String> fontNameMapping, @NonNull final Result result) {
        if (context != null) {
            ...
            resultHandler.error(result, "INVALID_CONTEXT", "Context is null.");
        }
    }
    ...
    protected void registerNewFFmpegPipe(@NonNull final Result result) {
        if (context != null) {
            resultHandler.success(result, FFmpegKitConfig.registerNewFFmpegPipe(context));
        } else {
    ...
    protected void getFFmpegVersion(@NonNull final Result result) {
        resultHandler.success(result, FFmpegKitConfig.getFFmpegVersion());
    }

    protected void isLTSBuild(@NonNull final Result result) {
        resultHandler.success(result, FFmpegKitConfig.isLTSBuild());
    }

    protected void getBuildDate(@NonNull final Result result) {
        resultHandler.success(result, FFmpegKitConfig.getBuildDate());
    }
    ...
    protected void ignoreSignal(@NonNull final Integer signalValue, @NonNull final Result result) {
        Signal signal = null;
        ...
        if (signal != null) {
            ...
            resultHandler.error(result, "INVALID_SIGNAL", "Signal value not supported.");
        }
    }
    ...
    protected void asyncFFprobeSessionExecute(@NonNull final Integer sessionId, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            if (session instanceof FFprobeSession) {
                ...
                resultHandler.error(result, "NOT_FFPROBE_SESSION", "A session is found but it does not have the correct type.");
            }
        }
    }
    ...
    protected void asyncMediaInformationSessionExecute(@NonNull final Integer sessionId, @Nullable final Integer waitTimeout, @NonNull final Result result) {
        ...
        if (session == null) {
            ...
            if (session instanceof MediaInformationSession) {
                ...
                resultHandler.error(result, "NOT_MEDIA_INFORMATION_SESSION", "A session is found but it does not have the correct type.");
            }
        }
    }

    protected void getLogLevel(@NonNull final Result result) {
        resultHandler.success(result, toInt(FFmpegKitConfig.getLogLevel()));
    }
    ...
    protected void getSessionHistorySize(@NonNull final Result result) {
        resultHandler.success(result, FFmpegKitConfig.getSessionHistorySize());
    }
    ...
    protected void getSessions(@NonNull final Result result) {
        resultHandler.success(result, toSessionArray(FFmpegKitConfig.getSessions()));
    }

    protected void getSessionsByState(@NonNull final Integer sessionState, @NonNull final Result result) {
        resultHandler.success(result, toSessionArray(FFmpegKitConfig.getSessionsByState(toSessionState(sessionState))));
    }

    protected void getLogRedirectionStrategy(@NonNull final Result result) {
        resultHandler.success(result, toInt(FFmpegKitConfig.getLogRedirectionStrategy()));
    }
    ...
    protected void messagesInTransmit(@NonNull final Integer sessionId, @NonNull final Result result) {
        resultHandler.success(result, FFmpegKitConfig.messagesInTransmit(sessionId.longValue()));
    }

    protected void getPlatform(@NonNull final Result result) {
        resultHandler.success(result, PLATFORM_NAME);
    }
        ...
        if (context != null) {
            if (activity != null) {
                try {
                    ...
                    resultHandler.error(result, "SELECT_FAILED", e.getMessage());
                }
            } else {
                ...
                resultHandler.error(result, "INVALID_ACTIVITY", "Activity is null.");
            }
        } else {
    ...
    protected void getSafParameter(@NonNull final Boolean writable, @NonNull final String uriString, @NonNull final Result result) {
        if (context != null) {
            ...
            if (uri == null) {
                ...
                resultHandler.error(result, "GET_SAF_PARAMETER_FAILED", "Uri string cannot be parsed.");
            } else {
                ...
                resultHandler.success(result, safParameter);
            }
        } else {
    ...
    protected void cancel(@NonNull final Integer sessionId, @NonNull final Result result) {
        FFmpegKit.cancel(sessionId.longValue());
        resultHandler.success(result, null);
    }

    protected void getFFmpegSessions(@NonNull final Result result) {
        resultHandler.success(result, toSessionArray(FFmpegKit.listSessions()));
    }

    // FFprobeKit

    protected void getFFprobeSessions(@NonNull final Result result) {
        resultHandler.success(result, toSessionArray(FFprobeKit.listSessions()));
    }
    ...
    protected void emitLog(final com.arthenica.ffmpegkit.Log log) {
        ...
        resultHandler.success(eventSink, logMap);
    }
    ...
    protected void emitStatistics(final Statistics statistics) {
        ...
        resultHandler.success(eventSink, statisticsMap);
    }
    ...
    protected void emitSession(final Session session) {
        ...
        resultHandler.success(eventSink, sessionMap);
    }
